...
<!-- <style scoped>
  ...
  .flex strong {
    text-decoration: underline #FFA9C5 16px;
    text-underline-offset: -4px;
    text-decoration-skip-ink: none;
  }
  .alignCenter {
